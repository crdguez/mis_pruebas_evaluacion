...
\begin{parts}
    \part[1] Resuelve la ecuación $\cos{x} = \sen^2{x}-1$
    \begin{solution}
        $[-90, 90, 180]$
    \end{solution}
...
\part[1] Escribe los siguientes números complejos en forma polar con el argumento en radianes:  $ -4 $ , $2i$, $ 2 - 2\sqrt {3}i $
\end{parts}
