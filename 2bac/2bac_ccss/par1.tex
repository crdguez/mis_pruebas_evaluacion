...
\begin{parts}
    ...
    \begin{solution}
        ...
        $2023=4\cdot505+3 \to A^{2023}=A^3=\left(\begin{matrix}1 & 0 & 0\\0 & 1 & 0\\0 & 0 & 1\end{matrix}\right)$
    \end{solution}
    \part[1] Determina, sin calcularla, si la matriz A tiene inversa y, en caso afirmativo, calcule su inversa.
    \begin{solution}
