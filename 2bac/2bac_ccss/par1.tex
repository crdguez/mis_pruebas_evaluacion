...
\end{solution}
\part[2] Determina los valores del parámetro $k$ para que la matriz: $$A-k\cdot I$$ tenga inversa.
\begin{solution}
...
\begin{parts}
\part[1] $\left|\begin{matrix}\frac{z}{2} & z+7 & 3\\\frac{y}{2} & y+0 & 3\\\frac{x}{2} & x-3 & 3\end{matrix}\right|$
\begin{solution}
