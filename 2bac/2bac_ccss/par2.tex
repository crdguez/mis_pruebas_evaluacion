...
\question Calcula los siquientes límites:
...
\part[1] Obtenga los intervalos de crecimiento y decrecimiento de $f(x)$
\part[1] Determine los extremos relativos indicando si corresponden a máximos o mínimos 	
\end{parts}
...
\part[1] Determine la recta tangente a $f$ en el punto donde $x=3$
