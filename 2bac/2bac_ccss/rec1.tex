...
\question
2015 pag 49 http://five-fingers.es/index.php/topmatematicasccnn \\
...
$
\begin{parts}
    \part  Estudiar las soluciones del sistema según los valores del parámetro $\lambda$.
    \part  Resolver el sistema cuando sea compatible indeterminado.
\end{parts}
