...
\begin{parts}
    ...
    \begin{solution}
    $\overrightarrow{u_r}= \left( 3, \  5, \  9\right) \to \left( - 5 x + 3 y - 5, \  - 3 x + z - 5\right)$ 
    \end{solution}
    ...
    \begin{solution}
        $\left(\begin{matrix}3 & 5 & 9\\-1 & 0 & 2\\1 & 1 & -3\end{matrix}\right)\to \dfrac{\left|\begin{matrix}3 & 5 & 9\\-1 & 0 & 2\\1 & 1 & -3\end{matrix}\right|}{6}=  - \frac{10}{3}$
