...
\part[1] Aplica la definición de logaritmo para calcular: ${\log _{{\raise0.7ex\hbox{$1$} \!\mathord{\left/
...
% \end{solution}
% \part[2] Sabiendo que $\log x=2$ y $\log y=-1$, calcula: $\log (\dfrac{\sqrt{x\cdot y}}{100\cdot x^2})$
% \begin{solution}
