...
% \part[2] La suma de las dos cifras de un número es 7, y la resta de ese número y el que resulta de invertir sus cifras es 9. ¿De qué número se trata? \begin{solution}43\end{solution}

% \part[2]Con dos tipos de barniz, de 3,50 \euro/kg y de 1,50 \euro/kg, queremos obtener un barniz de 2,22 \euro/kg. ¿Cuántos
% kilogramos tenemos que poner de cada clase para obtener 50 kg de la mezcla? \begin{solution}Soluc: 18 kg del barniz de 3,50 y 32 kg del de 1,50\end{solution}

% \part[2] Si el lado de un cuadrado aumenta 2 cm, su área aumenta 28 cm² ¿Cuáles son las dimensiones del cuadrado
% originario?\begin{solution}
